...
import * as NF from "./notes-files.js?v=202609040700";
import * as GC from "./gcal.js?v=202609040700";
import * as ST from "./notes-stats.js?v=202609040700";
import * as NW from "./notes-network.js?v=202609040700";
import { alumniNames } from "./addressbook.js?v=202609040700";
...
export async function initNotes(mountId = "notesapp") {
  ...
  if (folderEl) folderEl.addEventListener("change", async (e) => {
    ...
    const NFD = await import("./notes-folder.js?v=202609040700");
